...
# greenLower = (35, 60, 50) # (80,60,140)#
# greenUpper = (64, 255, 255) # (130,100,200)#
...
# 		if cur_char == ord('d'):
# 			cv2.circle(frame, center, int(radius), (200, 200, 0), 2)
# 			cv2.circle(ink, center, 5, (0, 255, 0), -1)
# 		if cur_char == ord('e'):
# 			cv2.circle(frame, center, 30,(0, 100, 255), 2)
# 			cv2.circle(ink, center, 30, (0, 0, 0), -1)
